...
export default function BulkPwReset() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          User Management - Bulk Password Reset
        </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {!useCsvPassword && (
            <div>
              <label style={{ fontWeight: 500, color: '#374151', display: 'block', marginBottom: 4 }}>
                Common Password
              </label>
              <input
                type="password"
          ...
          <button
            ...
            style={{
              marginTop: 10,
              backgroundColor: isProcessing ? '#1d4ed8aa' : '#2563eb',
              color: 'white',
              border: 'none',
              borderRadius: 6,
              padding: '12px 16px',
          ...
          {/* Status Messages Box with fixed height and scroll */}
          <div style={{
            marginTop: 25,
            fontSize: 13,
            whiteSpace: 'pre-wrap',
